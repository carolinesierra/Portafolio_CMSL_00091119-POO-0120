...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String nombre,nombres, ISBN, email;
        int paginas;
        char genero = 0;
        byte opGen;
        byte op;
        ...
        do {
            ...
            switch (op) {
                ...
                case 2:
                    ...
                    System.out.println("-------Su libro se eliminó con éxito--------");
